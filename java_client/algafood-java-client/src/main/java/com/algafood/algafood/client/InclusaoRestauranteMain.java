...
import com.algafood.algafood.client.api.ClientApiException;
import com.algafood.algafood.client.api.RestauranteClient;
import com.algafood.algafood.client.model.RestauranteModel;
import com.algafood.algafood.client.model.input.CidadeIdInput;
import com.algafood.algafood.client.model.input.CozinhaIdInput;
import com.algafood.algafood.client.model.input.EnderecoInput;
...
public class InclusaoRestauranteMain {
	public static void main(String[] args) {
		try {
			...
			var restauranteClient = new RestauranteClient(restTemplate, "http://api.algafood.local:8080");
